...
proto.SocketCmd.DeviceStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    lightstatus: (f = msg.getLightstatus()) && proto.SocketCmd.LightStatus.toObject(includeInstance, f)
  };
...
/**
 * optional LightStatus lightStatus = 23;
 * @return {?proto.SocketCmd.LightStatus}
 */
proto.SocketCmd.DeviceStatus.prototype.getLightstatus = function() {
  return /** @type{?proto.SocketCmd.LightStatus} */ (
    jspb.Message.getWrapperField(this, proto.SocketCmd.LightStatus, 23));
};


/** @param {?proto.SocketCmd.LightStatus|undefined} value */
proto.SocketCmd.DeviceStatus.prototype.setLightstatus = function(value) {
  jspb.Message.setWrapperField(this, 23, value);
};


proto.SocketCmd.DeviceStatus.prototype.clearLightstatus = function() {
  this.setLightstatus(undefined);
};
 ...
 * @return {!boolean}
 */
proto.SocketCmd.DeviceStatus.prototype.hasLightstatus = function() {
...
proto.SocketCmd.LightStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    lightbgusList: jspb.Message.getRepeatedField(msg, 34)
  };
 ...
 * @return {number}
 */
proto.SocketCmd.LightStatus.prototype.getCelladdr = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 12, 0));
};


/** @param {number} value */
proto.SocketCmd.LightStatus.prototype.setCelladdr = function(value) {
...
/**
 * repeated int32 lightBgus = 34;
 * @return {!Array.<number>}
 */
proto.SocketCmd.LightStatus.prototype.getLightbgusList = function() {
  return /** @type {!Array.<number>} */ (jspb.Message.getRepeatedField(this, 34));
};


/** @param {!Array.<number>} value */
proto.SocketCmd.LightStatus.prototype.setLightbgusList = function(value) {
 ...
 */
proto.SocketCmd.LightStatus.prototype.addLightbgus = function(value, opt_index) {
  jspb.Message.addToRepeatedField(this, 34, value, opt_index);
};


proto.SocketCmd.LightStatus.prototype.clearLightbgusList = function() {
  this.setLightbgusList([]);
};
